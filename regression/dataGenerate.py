...
np.savez('regression/data_1d.npz', X = X, X_min = X_min, X_max = X_max, X_n = X_n, T = T) # saves data in the file
...
np.savez('regression/data_2d.npz', X0 = X0, X1 = X1, X0_min = X0_min, X0_max = X0_max, \
